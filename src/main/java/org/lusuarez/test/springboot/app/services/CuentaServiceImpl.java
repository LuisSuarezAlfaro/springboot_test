package org.lusuarez.test.springboot.app.services;
...
public class CuentaServiceImpl implements CuentaService {
    ...
    public void transferir(Long numCuentaOrigen, Long numCuentaDestino, BigDecimal monto,
        ...
        Cuenta cuentaOrigien = cuentaRepository.findById(numCuentaOrigen).orElseThrow();
        cuentaOrigien.debito(monto);
        cuentaRepository.save(cuentaOrigien);
